...
if __name__ == '__main__':
    ...
    optparser.add_option("-s", "--srcfile", dest="src_file", default='chunker.py', help="name of source file for homework")
    optparser.add_option("-n", "--notebook", dest="notebook_file", default='chunker.ipynb', help="name of iPython notebook for homework")
