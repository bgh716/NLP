...
class ZipOutput:
    ...
    def run_all(self):
        ...
        if not (os.path.isfile(argv)):
            ...
            raise ValueError("Missing file {}".format(argv))
...
if __name__ == '__main__':
    ...
    optparser.add_option("-r", "--run", dest="run_program", default='chunker.py', help="run this program against testcases [default: chunker.py]")
