...
def translate(srcFile_path, model, test_iter):
    ...
    for i, batch in tqdm(enumerate(test_iter)):
        ...
        #print(src_tokens)
        #print(src_unknown_pos)
        
        #print(output)
        #print(len(tgt_words))
        #print(tgt_unknown_pos)
        #print('=====================\n\n')
...
class Seq2Seq(nn.Module):
    ...
    def tgt2word(self, tgt):
        return self.fields['tgt'].vocab.itos[int(tgt)]
    def src2txt(self, src):
        return " ".join([self.fields['src'].vocab.itos[int(i)] for i in src])
    def src2word(self, src):
        return self.fields['src'].vocab.itos[int(src)]
...
if __name__ == '__main__':
    ...
    optparser.add_option(
        ...
        help="input file")
    optparser.add_option(
        "-n", "--num", dest="num", default=20, type='int',
    ...
    print(model.tgt2txt([0,1,2,3,4,5,6,7]))
